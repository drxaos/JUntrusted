...
public abstract class GameBase extends AbstractGame {
    ...
    public com.github.drxaos.juntrusted.common.Point findNearest(String fromObjId, String toObjType) {
        ...
        if (found != null) {
            return new com.github.drxaos.juntrusted.common.Point(found.x, found.y);
        } else {
            return null;
        }
    }
    ...
    protected boolean configureLevel() {
        ...
        try {
            ...
            levelVm = new Project("level-vm")
                    ...
                    .addSystemClass(com.github.drxaos.juntrusted.common.Point.class.getName())
