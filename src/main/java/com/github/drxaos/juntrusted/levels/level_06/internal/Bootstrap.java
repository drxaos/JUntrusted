package com.github.drxaos.juntrusted.levels.level_06.internal;

import com.github.drxaos.juntrusted.levels.level_06.*;
import com.github.drxaos.juntrusted.levels.level_06.Object;
...
class Bootstrap {
    ...
    public static Boolean impassable(Definition d, Player player, String type, com.github.drxaos.juntrusted.levels.level_06.Object me) {
        try {
    ...
    public static void definitions(java.util.Map defMap) {
        ...
        defMap.put("exit", new Definition() {
            ...
            @Override
            public void onCollision(Player player) {
                next = "com.github.drxaos.jvmvm.ui.levels.level_07.internal.Game";
            }
        });
