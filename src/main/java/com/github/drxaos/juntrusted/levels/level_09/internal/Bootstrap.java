package com.github.drxaos.juntrusted.levels.level_09.internal;

import com.github.drxaos.juntrusted.levels.level_09.*;
import com.github.drxaos.juntrusted.levels.level_09.Object;
...
class Bootstrap {
    ...
    public static Boolean impassable(Definition d, Player player, String type, com.github.drxaos.juntrusted.levels.level_09.Object me) {
        try {
    ...
    public static void definitions(java.util.Map defMap) {
        ...
        defMap.put("exit", new Definition() {
            ...
            @Override
            public void onCollision(Player player) {
                next = "com.github.drxaos.jvmvm.ui.levels.level_09.internal.Game";
            }
        });
