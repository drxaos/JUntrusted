package com.github.drxaos.juntrusted.levels.level_03.internal;

import com.github.drxaos.juntrusted.levels.level_03.*;
...
class Bootstrap {
    ...
    public static void definitions(java.util.Map defMap) {
        ...
        defMap.put("exit", new Definition() {
            ...
            @Override
            public void onCollision(Player player) {
                next = "com.github.drxaos.jvmvm.ui.levels.level_04.internal.Game";
            }
        });
